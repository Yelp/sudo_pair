...
install -o root -g root -m 0644 ./sample/etc/sudo_pair.prompt.user /etc/sudo_pair.prompt.user
install -o root -g root -m 0644 ./sample/etc/sudo_pair.prompt.pair /etc/sudo_pair.prompt.pair
```
